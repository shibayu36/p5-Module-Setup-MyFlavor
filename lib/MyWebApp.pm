...
MyWebApp - pack from my-webapp

=head1 SYNOPSIS

  MyWebApp-setup --init --flavor-class=+MyWebApp new_flavor
...
template: |
  ...
  1;
---
file: lib/____var-module_path-var____/App.pm
template: |
  package [% module %]::App;
  use strict;
  use warnings;
  ...
  1;
---
file: lib/____var-module_path-var____/Teng.pm
template: |
  package [% module %]::Teng;
  use strict;
  use warnings;
  ...
  1;
---
dir: lib/____var-module_path-var____/App
---
...
template: |
  ...
  1;
---
file: lib/____var-module_path-var____/Teng/Schema.pm
template: |
  package [% module %]::Teng::Schema;
  use strict;
  use warnings;
